Report 76306 "Standard Sales - Invoice(1306)"
{
    RDLCLayout = './Layouts/StandardSalesInvoice.rdlc';
    WordLayout = './Layouts/Standard Sales - Invoice.docx';
